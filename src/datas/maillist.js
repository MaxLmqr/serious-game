const mails = {
  mail1: {
    ...
    date: "02/04/2019",
    expediteur: "DSI",
    mailexpediteur: "achuquet@emse.fr",
    content:
  ...
  mail3: {
    ...
    date: "11/12/2018",
    expediteur: "Léo PELLETIER ",
    mailexpediteur: "lpelletier@emse.fr",
    content:
    ...
    exp:
      " Il fallait faire attention ici ! Même si l'expéditeur semble légitime, il peut très bien arriver qu'une personne de l'école se fasse pirater sa boîte mail et que quelqu'un de mal intentionné l'utilise pour en pirater d'autres. Ici, Le lien redirige vers un site qui servira à récupérer vos données ! Faites attention car il est facile de copier un site quasiment à l'identique, vous ne verrez que c'est une copie qu'en regardant de près l'url !"
  },
  mail4: {
    id: 4,
    authenticated: "no",
    ...
    exp:
      "Même si la promotion semble attrayante, cette pièce jointe est suspecte ! Une pièce jointe inconnue peut contenir un virus. En ouvrant cette pièce jointe, vous pouvez lancer un programme qui donne un accès total à vos données à un pirate. De plus, l'expéditeur est \"prornotion\" au lieu de promotion. C'est une technique assez commune si vous regardez un peu dans vos spams."
  },
  mail5: {
    id: 5,
    authenticated: "yes",
  ...
  mail6: {
    ...
    date: "24/08/2019",
    expediteur: "Edouard Nee",
    mailexpediteur: "enee@mines-stetienne-dsi.fr",
    content:
    ...
    exp:
      "Le lien est frauduleux. Même si l'url ressemble à celle de l'école, ce n'est pas la même ! Ici on est redirigé vers 'portail-emse.fr' alors que la véritable url est 'portail.emse.fr', le pirate a donc acheté un nom de domaine similaire a celui de l'école pour avoir une grande crédibilité.."
  },
  mail7: {
    id: 7,
    authenticated: "yes",
  ...
  mail8: {
    ...
    date: "02/04/2019",
    expediteur: "Nathanaël Brugière",
    mailexpediteur: "nathanael.brugiere@outlook.fr",
    content:
      'Bonjour, <br><br> Nous testons une nouvelle fonctionnalité de gestion des absences, veuillez-vous rendre sur <a href="https://portail-emse.fr">ce lien</a>. <br><br>Il y a encore des bugs, donc il est possible que ça ne fonctionne pas pour tout le monde. <br><br>Cordialement, <br><br> Nathanaël Brugière',
    exp:
      "Vous recevez un mail d'une personne de l'administration, mais ce n'est pas son adresse de travail ! Ce n'est donc pas forcément son mail. Quelqu'un a pu créer un mail à son nom, c'est de l'usurpation d'identité. Faites attention, ici on voit clairement l'adresse mail entière de l'expéditeur, mais généralement dans une application vous ne voyez que le nom apparent, ici 'Nathanaël Brugière', et donc vous pourriez ne pas remarquer que c'est une adresse outlook, gmail, ou autre. De plus, le lien redirige vers un site qui n'est pas celui de l'école, même si il peut y ressembler en tout point. Vérifiez donc bien l'url lorsque l'on vous demande de vous connecter."
  },
  mail9: {
    id: 9,
    authenticated: "no",
    ...
    exp:
      "N'envoyez jamais vos identifiants par mails. On ne vous les demandera jamais de cette manière."
  },
  mail10: {
    id: 10,
    authenticated: "no",

...
const Mail = (props) => {
  ...
  return (
    <div className="ui middle aligned center grid segment">
      <div className="row">
        <div className="six wide column subject"><strong>{subject}</strong></div>
        <div className="ten wide column date">{date}</div>
      </div>
      <div className="row">
        <div className="three wide column expediteur">
          {expediteur}
        </div>
        <div className="ten wide column content" dangerouslySetInnerHTML={{__html: content}}></div>
